...
output_path = "/Users/mateusoliveira/Mateus/owshq/GitHub/ws-construindo-arq-modern-prj-analytics/demo/data-mesh/domain/analytical/credit_card_analytical_data.csv"
...
try:
    ...
    analytical_data.to_csv(output_path, index=False)
